...
from .const import (
    ...
    ATTR_VEHICLEPICURL,
    ATTR_BMSSOC,
    ATTR_BLUETOOTHADDRESS,
    ATTR_FULLCHARGETIME,
    ATTR_OTAVERSION,
    ATTR_SUPPORTNETWORKUNLOCK,
    ATTR_TOTALRIDEMILE,
    ATTR_SUPPORTUNLOCK,
    ATTR_WHETHERCHARGESTATE,
    ATTR_LOCATIONTIME,
    ATTR_RIDESTATE,
    ATTR_HEADLOCKSTATE,
    ATTR_CHARGESTATE,
...
async def async_setup_entry(hass, config_entry) -> bool:
    ...
    if not os.path.exists(f'{path}/zeeho.json'):
        ZeehoAccount.save_to_file(f'{path}/zeeho.json', {})
    varstinydict = ZeehoAccount.read_from_file(f'{path}/zeeho.json')
...
class autoamapEntity(TrackerEntity):
    ...
    _attr_name = None
    _attr_translation_key = "zeeho_device_tracker"
    ...
    def state_attributes(self): 
        ...
        if data:             
            attrs[ATTR_DEVICE_MODEL] = data["device_model"]
            attrs[ATTR_VEHICLENAME] = data["vehicleName"]
            attrs[ATTR_RIDESTATE] = data["rideState"]
